...
int main(int argc, char **argv)
{
	...
	// Test 2
	{
		...
		#pragma oss task weakcommutative(var[0], var[1], var[2], var[3], var[4]) label("cm0   cm0   cm0   cm0   cm0        ") shared(status, expected)
		{
		...
		#pragma oss task weakcommutative(var[0], var[1], var[2]) label("cm1   cm1   cm1                    ") shared(status, expected)
		{
		...
		#pragma oss task weakcommutative(var[1], var[2], var[4]) label("     cm3  cm3           cm3        ") shared(status, expected)
		{
		...
		#pragma oss task weakcommutative(var[3], var[5]) label("                  cm4   cm4   cm4  ") shared(status, expected)
		{
