...
#ifndef NANOS6_LITE_TASK_INSTANTIATION_H
#define NANOS6_LITE_TASK_INSTANTIATION_H
...
typedef struct __attribute__((aligned(64)))
{
	...
	//!
	//! This function should call the "nanos6_register_input_dep", "nanos6_register_output_dep"
	//! and "nanos6_register_inout_dep" functions to pass to the runtime the information needed
	...
	//!
	//! This function should be called by the runtime after the dependencies
	//! of the task have been satisfied. This function may register external
	//! events to delay the execution of the task, but cannot block the current
	//! thread in any blocking operation (e.g., taskwait or explicit blocking)
	//!
	//! \param[in] args_block a pointer to a block of data for the parameters
	...
	//! \brief Function that the runtime calls to perform any cleanup needed
	//! in the block of data of the parameters
	//!
	//! \param[in,out] args_block A pointer to a block of data for the parameters
	...
	//! \param[in,out] dest_args_block_pointer A pointer to a location to store the pointer
	//! to the destination array where the block of parameters is to be copied. If the task
	//! was created with the nanos6_preallocated_args_block flag, then it will be
	//! initialized by this function, otherwise, the runtime will initialize it
	...
	//! \param[in] size the (in Bytes) size of the data to be initialized during initialization
	...
	//! reductions' private storage
	//!
	//! \param[out] oss_out a pointer to the data where the combination is to be performed
...
//! call. Input if flags contains nanos6_preallocated_args_block, out otherwise
...
//! \brief Submit a task. Called after filling out the block of paramters of
//! the task. See nanos6_create_task
//!
...
#endif /* NANOS6_LITE_TASK_INSTANTIATION_H */
